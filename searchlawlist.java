...
public class searchlawlist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_searchlawlist);
        ...
        t0.setText(" C_section  ");
        t0.setTextColor(Color.WHITE);
        tbrow0.addView(t0);

        TextView tv0 = new TextView(this);
        tv0.setText(" punishment ");
        ...
        try{
            if(db!=null)
            {
                c=db.rawQuery("SELECT * from lawdetails where s4='"+search+"'",null);
                if(c.moveToFirst())
                {
                    do{
